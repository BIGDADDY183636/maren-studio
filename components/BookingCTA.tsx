export default function BookingCTA() {
  return (
    <section id="book" className="py-32 bg-cream-light">
      <div className="max-w-3xl mx-auto px-8 text-center">
        <p className="font-sans font-light text-[0.6rem] tracking-[0.38em] uppercase text-gold mb-7">
          Appointments
        </p>
        <h2
          className="font-serif font-light text-ink leading-[1.08] mb-7"
        ...
        <p className="font-serif italic text-[1.05rem] text-ink-soft leading-[1.75] max-w-sm mx-auto mb-14">
